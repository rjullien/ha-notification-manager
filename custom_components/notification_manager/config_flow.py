...
class NotificationManagerConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_reconfigure_phone(
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                "example": '{"rene": {"mobile": "notify.mobile_app_iphone_rene", "telegram_chat_id": 974020023}}'
            },
        )
    ...
    async def async_step_reconfigure_whatsapp(
        ...
        whatsapp_contacts : {"rene": "33616162068@s.whatsapp.net"}
        """
        entry = self.hass.config_entries.async_get_entry(self.context["entry_id"])
        errors: dict[str, str] = {}
        ...
        return self.async_show_form(
            ...
            errors=errors,
            description_placeholders={
                "example": '{"rene": "33616162068@s.whatsapp.net", "famille": "120363304818178160@g.us"}'
            },
        )
